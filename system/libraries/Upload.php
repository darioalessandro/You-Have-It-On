...
class CI_Upload {
	 ...
	 * Nota: La edite para que trabaje con arrays de imagenes post
	 * @return	bool
	 */
	public function do_upload($field = 'userfile', $key = 0)
	{
	...
	public function set_image_properties($path = '')
	{
		...
		if (function_exists('getimagesize'))
		{
			if (FALSE !== ($D = @getimagesize($path)))
			{
				...
				$this->image_type		= ( ! isset($types[$D['2']])) ? 'unknown' : strtolower($types[$D['2']]);
