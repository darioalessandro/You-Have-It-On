...
function openFrame(name, id){
	...
	fra.setAttribute("src", "<?php echo base_url().'adminqwy/load_imagestores?id='; ?>"+id+"&name="+name);
...
$query = Sys::pagination("SELECT * FROM store_locations ORDER BY name", $params, true);
...
<?php
	$config['base_url'] = base_url().'adminqwy/stores?p=s';
