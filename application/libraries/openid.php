...
class openid
{
    public $returnUrl
         ...
         , $capath = null
         , $cainfo = null
         , $google_identity = 'https://www.google.com/accounts/o8/id';
    ...
    /**
     * @param string $identity. cadena donde obtendra el id
     * @author gama
     */
    public function getIdSession($identity){
    	return str_ireplace($this->google_identity.'?id=', '', $identity);
    }
    ...
    protected function authUrl_v2($immediate)
    {
        $params = array(
        	...
        	'openid.pape.max_auth_age'  => '31536000',
