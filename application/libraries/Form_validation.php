...
class Form_validation {
	...
	function setArrayValidate($array){
		if(is_array($array))
			$this->_array_validate = $array;
	}
	...
	/**
	 * Traverse a multidimensional $this->_array_validate array index until the data is found
	 *
	 * @access	private
	 * @param	array
	 * @param	array
	...
	function _reset_post_array()
	{
		foreach ($this->_field_data as $field => $row)
		{
			if ( ! is_null($row['postdata']))
			{
				...
				{
					if (isset($this->_array_validate[$row['field']]))
					{
						$this->_array_validate[$row['field']] = $this->prep_for_form($row['postdata']);
					}
				}
				else
				{
					// start with a reference
					$post_ref =& $this->_array_validate;
	...
	{
		if ( ! isset($this->_array_validate[$field]))
		{
			return FALSE;
		}

		$field = $this->_array_validate[$field];
